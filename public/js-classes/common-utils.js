...
NavBar.createMarkup = function() {
    ...
    html += '                <li><a href="/order-pizza" class="white-shadow">PIZZAS</a></li>';
    html += '                <li><a href="/order-subs" class="white-shadow">SUBS</a></li>';
    html += '                <li><a href="/order-salads" class="white-shadow">SALADS</a></li>';
    html += '                <li><a href="/order-sides" class="white-shadow">SIDES</a></li>';
